    ...
    return (<>
        <section>
            <div className="grid grid-col-1 md:grid-cols-5">
                {/*Images Column*/}
                <div className="col-span2"> {/* Images component*/}
                        ...
                        <CardContent className="p-4">
                            ...
                            {product.stock > 0 && (
                                <div className="flex-center">
                                    <AddToCart item={{ productId: product.id, name: product.name, slug: product.slug, price: product.price, qty: 1, image: product.images![0] }} />
                                </div>
                            )}
                        </CardContent>
                    </Card>
